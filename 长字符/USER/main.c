...
//		
		...
		GUI_ShowCHinese(20,20,16,"欢迎来到重庆",1);
		
		delay_ms(1000);
		GUI_ShowCHinese(20,20,16,"来到重庆交通",1);
			delay_ms(1000);
	  GUI_ShowCHinese(20,20,16,"重庆交通大学",1);
       delay_ms(1000);
		 GUI_ShowCHinese(20,20,16,"交通大学实训",1);
		
       delay_ms(1000);
		 GUI_ShowCHinese(20,20,16,"大学实训室!",1);
  delay_ms(1000);
	 GUI_ShowCHinese(20,20,16,"实训室!",1);
  delay_ms(1000);
//	
